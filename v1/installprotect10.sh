...
@php
    ...
    if(auth()->user()->id !== 1) {
        ...
        $securityTeam = ["@DryzxModders", "@QueenMvaa", "@erortidakdiketaui"];
    }
@endphp
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@DryzxModders</span>
                <span class="team-badge" style="background: #74b9ff;">@QueenMvaa</span>
                <span class="team-badge" style="background: #55efc4;">@erortidakdiketaui</span>
            </div>
